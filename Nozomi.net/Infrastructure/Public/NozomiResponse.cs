...
namespace Nozomi.net.Infrastructure.Public
{
    ...
    /// </summary>
    public class NozomiResponse
    {
        /// <summary>Initializes a new instance of the <see cref="NozomiResponse"/> class.</summary>
        /// <param name="statusCode">The HTTP status code.</param>
        /// <param name="headers">The HTTP headers of the response.</param>
        /// <param name="content">The body of the response.</param>
        public NozomiResponse(HttpStatusCode statusCode, HttpResponseHeaders headers, string content)
        {
        ...
        /// <summary>Gets the date of the request, as returned by Nozomi.</summary>
        /// <value>The date of the request, as returned by Nozomi.</value>
        public DateTimeOffset? Date => this.Headers?.Date;

        /// <summary>Gets the idempotency key of the request, as returned by Nozomi.</summary>
        /// <value>The idempotency key of the request, as returned by Nozomi.</value>
        ...
        /// <summary>Returns a string that represents the <see cref="NozomiResponse"/>.</summary>
        /// <returns>A string that represents the <see cref="NozomiResponse"/>.</returns>
