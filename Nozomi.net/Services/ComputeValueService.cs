...
namespace Nozomi.net.Services
{
    ...
    /// </summary>
    public partial class ComputeValueService : IServiceOperations<NozomiApiClient>, IComputeValueService
    {
        /// <summary>
        ...
        /// </return>
        public async Task<HttpOperationResponse<object>> GETWithHttpMessagesAsync(int index, string computeGuid = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("computeGuid", computeGuid);
            ...
            if (computeGuid != null)
            {
                _queryParameters.Add(string.Format("computeGuid={0}", System.Uri.EscapeDataString(computeGuid)));
            }
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<IList<ComputeValueViewModel>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<HttpOperationResponse<object>> GET1WithHttpMessagesAsync(string guid, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<ComputeValueViewModel>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<object>> GET2WithHttpMessagesAsync(string computeGuid, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (computeGuid == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "computeGuid");
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
