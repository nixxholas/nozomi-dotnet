...
namespace Nozomi.net.Services
{
    ...
    /// </summary>
    public partial class WebsocketCommandPropertyService : IServiceOperations<NozomiApiClient>, IWebsocketCommandPropertyService
    {
        /// <summary>
        ...
        public async Task<HttpOperationResponse<object>> GETWithHttpMessagesAsync(int? index = 0, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<IList<WebsocketCommandPropertyViewModel>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<object>> GET1WithHttpMessagesAsync(string commandGuid = default(string), int? index = 0, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
            if (_shouldTrace)
            {
                _invocationId = ServiceClientTracing.NextInvocationId.ToString();
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("commandGuid", commandGuid);
                tracingParameters.Add("index", index);
                tracingParameters.Add("cancellationToken", cancellationToken);
            ...
            if (commandGuid != null)
            {
                _queryParameters.Add(string.Format("commandGuid={0}", System.Uri.EscapeDataString(commandGuid)));
            }
            if (index != null)
            {
                _queryParameters.Add(string.Format("index={0}", System.Uri.EscapeDataString(Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(index, Client.SerializationSettings).Trim('"'))));
