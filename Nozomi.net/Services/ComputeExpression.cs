...
namespace Nozomi.net.Services
{
    ...
    /// </summary>
    public partial class ComputeExpression : IServiceOperations<NozomiAPI>, IComputeExpression
    {
        /// <summary>
        ...
        /// </exception>
        public ComputeExpression(NozomiAPI client)
        {
            if (client == null)
            {
        ...
        public async Task<HttpOperationResponse<object>> GETWithHttpMessagesAsync(int index, string computeGuid = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<IList<ComputeExpressionViewModel>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<HttpOperationResponse<object>> GET1WithHttpMessagesAsync(string guid, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<ComputeExpressionViewModel>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
