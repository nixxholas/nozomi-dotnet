...
namespace Nozomi.net.Services
{
    ...
    /// </summary>
    public partial class ComponentTypeService : IServiceOperations<NozomiApiClient>, IComponentTypeService
    {
        /// <summary>
        ...
        public async Task<HttpOperationResponse<object>> GETWithHttpMessagesAsync(int? index = 0, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<IList<ComponentTypeViewModel>>(_responseContent, Client.DeserializationSettings);
                }
